...
*/
public class AsignarJefePedidosSucursalSCR extends javax.swing.JFrame {
	/**
	 * 
	 */
	private static final long serialVersionUID = -1016089226764199113L;
	...
	*/
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				AsignarJefePedidosSucursalSCR inst = new AsignarJefePedidosSucursalSCR();
	...
	public AsignarJefePedidosSucursalSCR() {
		super();
		initGUI();
	}
	...
	private void initGUI() {
		try {
			...
			this.setTitle("Asignar Jefe de Pedidos a Sucursal");
			...
			}
			{
				...
				jLabelGerenteActual.setText("Jefe actual: ");
...
//				}
			...
			}
			{
				...
				jButtonModificar.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent arg0) {
						...
						if(editadodto.getIdRecepcionPedidos() == null)
							jLabelNombreGerenteActual.setText("Sin Jefe");
						//busco empleados 
						if(listaedto != null){
							int i = 0;
							String[] descs = new String[80];
							for (EmpleadoDTO t : listaedto){
								if(t.getFechaEgreso() == null){
									if(t.getId().equals(editadodto.getIdRecepcionPedidos())){ 
			...
			}
			{
				...
				jLabelIndicacion2.setText("Elija el Jefe y pulse Aceptar:");
					...
					public void actionPerformed(ActionEvent arg0) {
						...
						String val = null;
							if(jListEmpleados.isSelectionEmpty()){
								editadodto.setIdRecepcionPedidos(null);
								try {
									...
									BusinessDelegate.getInstancia().modificarSucursal(editadodto);
										...
										jLabelMensaje.setText("Se eliminó Jefe de Pedidos de Sucursal ");
										jButtonAceptar.setEnabled(false);
						...
						for(EmpleadoDTO busedto : listaedto){
							if(busedto.getNombre().equals(splitStr[0])  && busedto.getApellido().equals(splitStr[1]) ){
								...
								try {
									...
									editadodto.setIdRecepcionPedidos(busedto.getId());
									 
									BusinessDelegate.getInstancia().modificarSucursal(editadodto);
									 
										jLabelMensaje.setText("Se asignó el Jefe "+ busedto.getNombre()+ " "+ busedto.getApellido());
										jButtonAceptar.setEnabled(false);
										jListEmpleados.setEnabled(false);
									} catch (RemoteException e) {
										// TODO Auto-generated catch block
